            ...
            >
              <div>
                <font-awesome-icon
                  icon="image"
                  size="2xl"
                  style="color: var(--main-color); width: 150px; height: 150px"
                />
              </div>
              <div
            ...
            <v-tabs-window v-model="tab">
              <v-tabs-window-item value="party">
                <v-container
                  ...
                  width="90%"
                >
                  <v-card v-for="photo in party" :key="photo.id" width="25%">
                    <v-img :src="photo.image" height="200" cover></v-img>

                    <v-card-title>
                      <font-awesome-icon
                        @click="photos.delete_Photo(photo.id)"
                        :icon="['fas', 'trash']"
                      />
                    </v-card-title>
                  </v-card>
              ...
              <v-tabs-window-item value="news">
                <v-container
                  ...
                  width="90%"
                >
                  <v-card v-for="photo in news" :key="photo.id" width="25%">
                    <v-img :src="photo.image" height="200"></v-img>
              ...
              <v-tabs-window-item value="trip">
                <v-container
                  ...
                  width="90%"
                >
                  <v-card v-for="photo in trip" :key="photo.id" width="25%">
                    <v-img :src="photo.image" height="200"></v-img>
