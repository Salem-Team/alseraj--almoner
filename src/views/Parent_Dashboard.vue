  ...
  <div class="profile-container">
    <div class="header" v-if="user">
      ...
      <div class="action-buttons">
        <v-btn color="primary ml-2" small @click="Edit">تعديل البيانات</v-btn>
    ...
    <v-card class="profile-card">
      <v-toolbar color="info" dark flat>
        <v-toolbar-title class="text-center">الصفحه الشخصيه</v-toolbar-title>
      </v-toolbar>
              ...
              <v-card-text>
                ...
                >
                  ...
                  <v-col
                    ...
                    class="d-flex flex-column align-center"
                  >
                    <strong class="text-h6">الصف الدراسي:</strong>
