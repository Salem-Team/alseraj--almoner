      ...
      <div class="d-flex flex-row" style="width: 100%; height: 100vh">
        ...
        >
          <v-tabs-window-item value="option-1">
            <v-card flat v-if="student" class="mx-auto my-4" max-width="90%">
              <v-card-title
                style="background: #54a0ff; border-radius: 20px; padding: 24px"
              ...
              >
                <img
                  ...
                  class="avatar-hover"
                />
                <h2 class="text-h5 mt-2 mb-1 text-white">{{ student.name }}</h2>
                ...
                <v-container fluid>
                  <v-row class="ma-10">
                    <v-col cols="12" sm="6" class="d-flex justify-center">
                      <v-card class="pa-3 mb-3 fixed-card" outlined>
                        <v-card-title
                    ...
                    >
                      <v-card class="pa-3 mb-3 fixed-card" outlined>
                        ...
                        <v-card-subtitle
                          class="custom-font centered-subtitle"
                          style="font-size: 16px"
                          >{{ student.BithOfDate }}</v-card-subtitle
                        >
                      </v-card>
                    </v-col>
                    <v-col cols="12" sm="6" class="d-flex justify-center">
                      <v-card class="pa-3 mb-3 fixed-card" outlined>
                        ...
                        <v-card-subtitle
                          class="custom-font centered-subtitle"
                          style="font-size: 16px"
                          >{{ student.gradeLevel }}</v-card-subtitle
                        >
                      </v-card>
                    </v-col>
                    <v-col cols="12" sm="6" class="d-flex justify-center">
                      <v-card class="pa-3 mb-3 fixed-card" outlined>
                        ...
                        <v-card-subtitle
                          class="custom-font centered-subtitle"
                          style="font-size: 16px"
                          >{{ student.schoolYear }}</v-card-subtitle
                        >
                      </v-card>
                    </v-col>
                  </v-row>
              ...
              <v-list>
                <v-list-item>
                  <v-table>
                    ...
                    <tbody>
                      <tr
                        v-for="(result, index) in student.Results.weeklyResults"
                        :key="index"
                      >
                        <td>{{ result.Subject_Name }}</td>
                        <td>{{ result.Major_degree }}</td>
                        <td>{{ result.Student_degree }}</td>
                      </tr>
                    </tbody>
                  </v-table>
                </v-list-item>
          ...
          <v-tabs-window-item value="option-3" style="width: 100% !important">
            <v-card flat>
              <v-row class="d-flex flex-row align-center justify-space-between">
                ...
                <v-col class="d-flex justify-end">
                  <v-btn color="blue" class="ml-5" @click="downloadPDF">
                    <v-icon left size="25px" class="ml-2">mdi-printer</v-icon>
                    تحميل الشهادة
                  </v-btn>
                </v-col>
              </v-row>
              ...
              >
                <v-col>
                  <v-col>
                    ...
                    <v-text-title>{{ student.name }}</v-text-title>
                  </v-col>
                  <v-col>
                    <v-text-title>المرحلة الدراسية:</v-text-title>
                    <v-text-title>{{ student.gradeLevel }}</v-text-title>
                  </v-col>
                  <v-col>
                    <v-text-title>السنة الدراسية:</v-text-title>
                    <v-text-title>{{ student.schoolYear }}</v-text-title>
                  </v-col>
                </v-col>
                <v-col class="d-flex flex-column align-end">
                  ...
                  >
                    <img src="../assets/images.jpeg" alt="School Logo" />
              ...
              <div class="table">
                <v-table>
                  ...
                  <tbody>
                    <tr
                      v-for="(degree, index) in selectedMonthlyDegrees"
                      :key="index"
                    >
                      <td>{{ degree.Subject_Name }}</td>
                      <td>{{ degree.Teacher_Name }}</td>
                      <td>{{ degree.Behavior_assessment }}</td>
              ...
              <v-container fluid>
                <v-row class="ma-10">
                  <v-col cols="12" sm="4" class="d-flex justify-center">
                    <v-card class="pa-3 fixed-card mb-3" outlined>
                      <v-card-title
                        class="custom-title custom-font text-center"
                        style="font-size: 20px"
                      >
          ...
          <v-tabs-window-item value="option-6">
            ...
            <v-alert type="error" v-else> لا يوجد بيانات لهذا الطالب </v-alert>
          </v-tabs-window-item>
          ...
          <v-tabs-window-item value="option-7">
            <v-card flat v-if="student">
              ...
              >
                <v-list-item-content>
                  <v-list-item-title>{{ statistic.data }}</v-list-item-title>
                </v-list-item-content>
              </v-list-item>
            </v-card>
          </v-tabs-window-item>
