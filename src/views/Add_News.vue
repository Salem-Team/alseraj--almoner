<template>
  <div class="use">
    <div class="title">
      <div class="right">
        <v-breadcrumbs
          :items="['الاشراف', 'الاعدادات', 'الاخبار']"
        ></v-breadcrumbs>
      </div>
      <div class="left">
        <font-awesome-icon @click="dialog = true" :icon="['fas', 'plus']" />
      </div>
    </div>
  </div>
  ...
  >
  <v-container class="box d-flex align-center justify-space-around" width="90%">
